...
import { rentNFTTransactionsService } from "../services/RentNFTTransactionsService.jsx";
import { rentNFTScriptsService } from "../services/RentNFTScriptsService.jsx";
  ...
  return (
    <Wrapper>
      ...
      <section className="scrow flexColumn">
        ...
        <div className="ended">
        <button onClick={() => getEndedScrowsIds()}>Get Ended Scrow Ids</button>
        <div>
          <p>ENDED SCROW IDs</p>
          <div className="ids">
            {endedScrowsIds != null &&
        ...
        <form onSubmit={(e) => getEndedScrowDataSubmit(e)}>
          ...
          {endedScrowData != null && (
            <>
              ...
              <p>
                End of Rent: {convertTimestampToDate(endedScrowData.endOfRent)}
              </p>
              <p>
                Date of End: {convertTimestampToDate(endedScrowData.dateOfEnd)}
              </p>
            </>
          )}
        </form>
